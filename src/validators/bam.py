"""
BAM file validator using samtools.

This module provides functionality to validate BAM (Binary Alignment Map) files
using the samtools quickcheck command.
"""
import os
import subprocess
import logging
...
class BamValidator:
    """
    Validator for BAM files using samtools quickcheck.
    
    This class provides methods to validate BAM files by utilizing
    ...
    def validate_file(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if process.returncode == 0:
                ...
                result["valid"] = False
                result["errors"]["invalid_format"] = process.stderr.strip() or "BAM file failed validation"
    ...
    def validate_stream(self, input_stream: IO[bytes], is_gzipped: bool = False) -> Dict[str, Any]:
        ...
        Args:
            ...
            is_gzipped: Whether the stream contains gzipped data (not used for BAM)
