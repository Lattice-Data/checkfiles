config = {
    ...
    'ami_id_production': 'ami-0c74fc746d4803d21', # latest checkfiles AMI
    'portal_secrets_arn_production': 'arn:aws:secretsmanager:us-west-1:585222078325:secret:checkfiles-portal-secret-5A1cNL',
    'slack_channel_id': 'arn:aws:secretsmanager:us-west-1:585222078325:secret:slack-channel-id-lWBvOZ',
    'slack_token': 'arn:aws:secretsmanager:us-west-1:585222078325:secret:bot-token-Z0jak9',
